...
import culturalDetailMethod from "../../../model/collegeDetail/cultural.js"
import { fileUrl } from '../../../utility/fileServerConfig.js';
import bucket from '../../../utility/firebaseutility.js';

const culturalCreateMethod = async (req, res) => {
    try {
        ...
        const culturalData = await culturalDetailMethod.insertMany(ObjToDocArray);
...
export default culturalCreateMethod;